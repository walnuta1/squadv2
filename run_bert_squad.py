...
Copied out of https://github.com/google-research/bert"""
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):    # pylint: disable=unused-argument
        ...
        if init_checkpoint:
            ...
            ) = bert.get_assignment_map_from_checkpoint(tvars, init_checkpoint)
            if use_tpu:
...
def write_predictions(all_examples, all_features, all_results, n_best_size,
    ...
    for feature in all_features:
        example_index_to_features[feature.features.feature["example_index"].int64_list.value].append(feature)
